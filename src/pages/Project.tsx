...
const projects: Project[] = [
    {
        ...
        lat: -7.817,
        lng: 110.456,
        description: "Gepo Energy bekerja sama dengan Dewan Energi Mahasiswa UGM (DEM UGM) melakukan instalasi Genting Photovoltaic (GEPO) sebanyak 30 unit dengan kapasitas 300 Wp sistem hybrid. Daya digunakan untuk pompa air pengairan kebun lidah buaya dan fasilitas umum.",
        photos: [
            "/images/projects/tamanan1.jpeg",
            "/images/projects/tamanan2.png",
        ],
    },
    {
        id: 2,
        ...
        photos: [
            "/images/projects/pitu1.jpeg",
            "/images/projects/pitu2.png",
        ],
    },
    {
        id: 3,
        ...
        photos: [
            "/images/projects/dlingo1.jpeg",
            "/images/projects/dlingo2.jpeg",
        ],
    },
];
    ...
    return (
        <div style={{ width: "350px", fontFamily: "inherit" }}>
            ...
            <div style={{
                ...
                <h3 style={{ margin: 0, fontSize: "16px", fontWeight: 700 }}>{project.title}</h3>
                <p style={{ 
                margin: "4px 0 0", 
                fontSize: "13px", 
                fontWeight: 500,
                display: "flex",          // Membuat isi p menjadi flexbox
                alignItems: "center",     // Menyejajarkan ikon dan teks secara vertikal di tengah
                gap: "4px"                // Memberikan jarak antara ikon dan teks (lebih rapi dibanding marginRight)
                }}>
            ...
            <div style={{ padding: "14px 16px", background: "#FFFFFF" }}>
                <div style={{
                    ...
                    <div style={{ background: "#fffbebda", borderRadius: "8px", padding: "10px 12px" }}>
                        <p style={{ margin: 0, fontSize: "11px", color: "#FFD700", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>Kapasitas</p>
                        <p style={{ margin: "4px 0 0", fontSize: "12px", fontWeight: 700, color: "#111827" }}>{project.capacity}</p>
                    </div>
                    <div style={{ background: "#fffbebda", borderRadius: "8px", padding: "10px 12px" }}>
                        <p style={{ margin: 0, fontSize: "11px", color: "#FFD700", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>Tipe</p>
                        <p style={{ margin: "4px 0 0", fontSize: "12px", fontWeight: 700, color: "#111827" }}>{project.tipe}</p>
                    </div>
                </div>
